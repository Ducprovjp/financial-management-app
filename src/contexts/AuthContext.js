...
export function AuthProvider({ children }) {
  ...
  useEffect(() => {
    const defaultUser = { uid: "defaultUserIdd", displayName: "ITSS2" };
  ...
  function signup(name, email, password) {
    ...
    const defaultUser = { uid: "defaultUserIdd", displayName: name };
    setCurrentUser(defaultUser);
  ...
  function login(email, password) {
    ...
    // Giả lập đăng nhập
    const defaultUser = { uid: "defaultUserIdd", displayName: "Default User" };
    setCurrentUser(defaultUser);
  }
